odoo.define('mrp_order_planning.mrp_production_variant_mgmt_report_backend', function (require) {
'use strict';

var core = require('web.core');
var Widget = require('web.Widget');
var ControlPanelMixin = require('web.ControlPanelMixin');
var ReportWidget = require('mrp_order_planning.mrp_production_variant_mgmt_report_widget');
var QWeb = core.qweb;

var MrpVariantMgmtReportBackend = Widget.extend(ControlPanelMixin, {
    ...
    renderButtons: function(buttons) {
        var self = this;
        this.$buttons = $(QWeb.render("MrpProductionVariantMgmt.buttons", {buttons: this.buttons}));
...
core.action_registry.add("mrp_production_variant_mgmt_report_backend", MrpVariantMgmtReportBackend);
return MrpVariantMgmtReportBackend;
});
